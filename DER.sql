...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_usuarios` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_usuarios_tb_produtos_idx` (`usuario_id` ASC) VISIBLE,
  INDEX `fk_tb_usuarios_tb_categorias1_idx` (`categorias_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_usuarios_tb_produtos`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `db_loja_games`.`tb_produtos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuarios_tb_categorias1`
